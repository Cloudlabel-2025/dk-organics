          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '40px' }}>
            {[1, 2, 3, 4].map((i) => (
              <div key={i} style={{ backgroundColor: 'white', borderRadius: '40px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
                <div style={{ height: '250px', backgroundColor: '#e0e0e0' }}></div>
                <div style={{ padding: '30px' }}>
                  <div style={{ height: '24px', backgroundColor: '#e0e0e0', borderRadius: '8px', marginBottom: '15px' }}></div>
                  <div style={{ height: '80px', backgroundColor: '#e0e0e0', borderRadius: '8px', marginBottom: '20px' }}></div>
                  <div style={{ height: '20px', backgroundColor: '#e0e0e0', borderRadius: '8px', width: '60%' }}></div>
                </div>
              </div>
            ))}
          </div>
